...
void DeviceView::setDirection(bool v){
    speed = v ? 1 : -1;
}

void DeviceView::step(double v) {
    Phi += v;
    repaint();
}
...
void DeviceView::setTextVisibility(bool TextVisibility){
    text_visibility = TextVisibility;
    repaint();
}

void DeviceView::setGridVisibility(bool grid_visibility){
