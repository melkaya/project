...
static const char qt_meta_stringdata_DeviceView[] = {
    ...
    "setColorMap(ColorMap)\0setTextVisibility(bool)\0"
    "setDirection(bool)\0step(double)\0"
    "setGridVisibility(bool)\0"
};
...
int DeviceView::qt_metacall(QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 11: setTextVisibility((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 12: setDirection((*reinterpret_cast< bool(*)>(_a[1]))); break;
        case 13: step((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 14: setGridVisibility((*reinterpret_cast< bool(*)>(_a[1]))); break;
        default: ;
        }
        _id -= 15;
    }
