...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    offsetof(qt_meta_stringdata_DeviceView_t, stringdata) + ofs \
...
QT_MOC_LITERAL(7, 43, 4)
    ...
    "DeviceView\0setL1\0\0setL2\0setL3\0setPhi\0"
    "start\0stop\0"
};
...
void DeviceView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        switch (_id) {
        case 0: _t->setL1((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 1: _t->setL2((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 2: _t->setL3((*reinterpret_cast< double(*)>(_a[1]))); break;
        case 3: _t->setPhi((*reinterpret_cast< double(*)>(_a[1]))); break;
...
const QMetaObject DeviceView::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_DeviceView.data,
      qt_meta_data_DeviceView,  qt_static_metacall, 0, 0}
};
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_DeviceView.stringdata))
